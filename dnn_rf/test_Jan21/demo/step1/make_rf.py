...
def main():
	...
	y = tf.placeholder(tf.int32, shape=[None,1],name ='y_')
	...
	init_vars = tf.group(tf.global_variables_initializer(),resources.initialize_resources(resources.shared_resources()),name="init_vars")
